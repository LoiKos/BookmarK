			...
			<div className="columns">
				<div className="column is-half is-offset-one-quarter">
					<div className="card">
					  <div className="card-content">
					    <div className="media">
					      ...
					      <div className="media-content">
					        <a href={this.props.media.url} target="_blank"><p className="title is-4 has-text-info">{this.props.media.title} </p></a>
					  ...
					  <ActionFooter handleClick={() => this.props.handleDelete(this.props.media.url)} handleUpdate={(tags) => this.props.handleUpdate(this.props.media.url,tags)} tag={this.props.media.tags}/>
					</div>
				</div>
			</div>
